...
public class TestPeriferice2 {
    public static void main(String[] args) {
        ...
        // Crearea listei de mouse-uri
        ArrayList<Mouse> mouseuri = new ArrayList<>();
        Mouse mouse1 = new Mouse("Logitech", "MX Master 3", 499.99, "Windows, MacOS, Linux", 4000, 7, true);
        ...
        Mouse mouse7 = new Mouse("Corsair", "Dark Core RGB", 599.99, "Windows, Linux", 16000, 8, true);
        ...
        // Crearea listei de camere video
        ...
        CameraVideo camera6 = new CameraVideo("Logitech", "Brio 4K", 999.99, "Windows, Linux, MacOS", 2160, 60, true);
        ...
        CameraVideo camera10 = new CameraVideo("Trust", "Spotlight Pro", 149.99, "Windows, Linux", 720, 30, false);
        ...
        Microfon microfon4 = new Microfon("Samson", "Meteor", 299.99, "Windows, Linux", -42, "USB", false);
        ...
        Microfon microfon8 = new Microfon("Logitech", "Blue Snowball", 399.99, "Windows, Linux", -38, "USB", true);
        ...
        System.out.println(microfoane.get(2));

        // Filtrarea tastaturilor
        System.out.println("\n");
        System.out.println("Introduceti sistemul de operare pentru tastaturi (ex: Windows, Linux, MacOS):");
        String sistemOperareTastaturi = scanner.nextLine();
        System.out.println("Doriti tastaturi cu iluminare? (true/false):");
        boolean iluminareTastaturi = scanner.nextBoolean();
        scanner.nextLine(); // consumă linia rămasă

        System.out.println("\nTastaturi care indeplinesc conditiile:");
        for (Tastatura tastatura : tastaturi) {
            if (tastatura.compatibilitateSO.contains(sistemOperareTastaturi) && tastatura.isIluminare() == iluminareTastaturi) {
                System.out.println(tastatura.obtineDetalii());
            }
        }
/**
        // Filtrarea mouse-urilor
        System.out.println("\n");
        System.out.println("Introduceti sistemul de operare pentru mouse-uri (ex: Windows, MacOS):");
        String sistemOperareMouse = scanner.nextLine();
        System.out.println("Doriti mouse-uri wireless? (true/false):");
        boolean wirelessMouse = scanner.nextBoolean();
        scanner.nextLine(); // consumă linia rămasă

        System.out.println("\nMouse-uri care indeplinesc conditiile:");
        for (Mouse mouse : mouseuri) {
            if (mouse.compatibilitateSO.contains(sistemOperareMouse) && mouse.isWireless() == wirelessMouse) {
...
**/
        ...
        System.out.println();
        System.out.println("\nIntroduceti sistemul de operare pentru mouse-uri (ex: Windows, Linux, MacOS):");
        String sistemOperareMouse = scanner.nextLine();
        ...
        // Filtrarea camerelor video
        System.out.println("\n");
        System.out.println("Introduceti sistemul de operare pentru camere video (ex: Windows, Linux, MacOS):");
        String sistemOperareCamere = scanner.nextLine();
        System.out.println("Doriti camere cu microfon? (true/false):");
        boolean microfonCamere = scanner.nextBoolean();
        scanner.nextLine(); // consumă linia rămasă

        System.out.println("\nCamere video care indeplinesc conditiile:");
        for (CameraVideo camera : camere) {
            if (camera.compatibilitateSO.contains(sistemOperareCamere) && camera.haveMicrofonn() == microfonCamere) { 
                System.out.println(camera.obtineDetalii());
            }
        }
/**
        // Filtrarea microfoanelor
        System.out.println("\n");
        System.out.println("Introduceti sistemul de operare pentru microfoane (ex: Windows, MacOS):");
        String sistemOperareMicrofoane = scanner.nextLine();
        System.out.println("Doriti microfoane pentru conferinta? (true/false):");
        boolean conferintaMicrofoane = scanner.nextBoolean();
        scanner.nextLine();
        System.out.println("\nMicrofoane care indeplinesc conditiile:");
        for (Microfon microfon : microfoane) {
            if (microfon.compatibilitateSO.contains(sistemOperareMicrofoane) && microfon.isConferinta() == conferintaMicrofoane) {
...
**/
            // Metoda parcurgere Microfoane cu for-each
        System.out.println();
        System.out.println("\nIntroduceti sistemul de operare pentru microfoane (ex: Windows, Linux, MacOS):");
        String sistemOperareMicrofoane = scanner.nextLine();
        ...
        // Filtrarea microfoanelor folosind un for clasic
        System.out.println("\nMicrofoane care indeplinesc conditiile:");
            for (int i = 0; i < microfoane.size(); i++) {
                Microfon microfon = microfoane.get(i); // Obținem microfonul curent din listă
             if (microfon.compatibilitateSO.contains(sistemOperareMicrofoane) && microfon.isConferinta() == conferintaMicrofoane) {
                System.out.println(microfon.obtineDetalii());
            }
        }
